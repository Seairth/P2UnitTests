...
_test	rdlong	d, ptra++
	...
	testb	d, s wc, wz	' TEST INSTRUCTION
...
testc	long	(cnt-tests)/5
	'       d           s            cz  r           rcz
tests	long	$0000_0000, $0000_0000, %10, $0000_0000, %01
	long	$0000_0001, $0000_0000, %01, $0000_0001, %10
	long	$0000_000F, $0000_0003, %00, $0000_000F, %10
	long	$0000_0007, $0000_0003, %00, $0000_0007, %01
	long	$AAAA_AAAA, $FFFF_FFE0, %00, $AAAA_AAAA, %01
