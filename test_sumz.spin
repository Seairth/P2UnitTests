...
_test	rdlong	d, ptra++
	...
	sumz	d, s wc, wz	' TEST INSTRUCTION
...
testc	long	(cnt-tests)/5
	'       d           s            cz  r           rcz
tests	long	$0000_0001, $0000_0001, %10, $0000_0002, %00
	long	$0000_0001, $0000_0001, %01, $0000_0000, %01
	long	$0000_0001, $FFFF_FFFF, %00, $0000_0000, %01
	long	$FFFF_FFFF, $FFFF_FFFF, %10, $FFFF_FFFE, %00
	long	$FFFF_FFFF, $FFFF_FFFF, %01, $0000_0000, %01
	long	$FFFF_FFFF, $0000_0001, %00, $0000_0000, %01
	long	$8000_0000, $0000_0001, %10, $8000_0001, %00
	long	$8000_0000, $0000_0001, %11, $7FFF_FFFF, %10
	long	$8000_0000, $FFFF_FFFF, %10, $7FFF_FFFF, %10
	long	$7FFF_FFFF, $FFFF_FFFF, %10, $7FFF_FFFE, %00
	long	$7FFF_FFFF, $FFFF_FFFF, %11, $8000_0000, %10
	long	$7FFF_FFFF, $0000_0001, %10, $8000_0000, %10
