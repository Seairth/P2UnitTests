...
.i	setbyte	d, s, #0	' TEST INSTRUCTION
...
testc	long	(cnt-tests)/5
	'       d           s            cz  r           rcz
tests	long	$1234_5678, $FAFB_FCFD, %11, $1234_56FD, %11
	long	$1234_5678, $FAFB_FCFD, %11, $1234_FD78, %11
	long	$1234_5678, $FAFB_FCFD, %11, $12FD_5678, %11
	long	$1234_5678, $FAFB_FCFD, %11, $FD34_5678, %11
